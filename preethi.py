...
print('Loading your AI personal assistant - Ree')
...
speak("Loading your AI personal assistant May")
wishMe()
...
if __name__ == '__main__':
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak('I am Ree, version 1.0, your personal assistant. I am programmed to perform tasks such as opening YouTube, Google Chrome, Gmail, and StackOverflow, predicting time, taking photos, searching Wikipedia, predicting weather in different cities, getting top headline news from Times of India, and answering computational or geographical questions.')

        elif "who made you" in statement or "who created you" in statement or "who discovered you" in statement:
            speak("I was built by Preethi")
            print("I was built by Preethi")
